...
exports.run = async (client, message, args, settings) => {
    ...
    try {
    let results = await fetch(`https://nekos.life/api/v2/img/les`)
    .then(res => res.json())
...
exports.data = {
  name: "les", // name of command used on lists etc...
  category: "NSFW", // what category the command is in
  usage: "les", // how to use the command
  description: "Grabs a random NSFW les image", // description of what the command does
