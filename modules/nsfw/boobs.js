...
exports.run = async (client, message, args) => {
    ...
    try {
    let results = await fetch(`https://nekos.life/api/v2/img/boobs`)
    .then(res => res.json())
...
exports.data = {
  name: "boobs", // name of command used on lists etc...
  category: "NSFW", // what category the command is in
  usage: "boobs", // how to use the command
  description: "Grabs a random NSFW boobs image", // description of what the command does
