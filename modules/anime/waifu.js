...
exports.run = async (client, message, args) => {
    ...
    try {
    let results = await fetch(`https://nekos.life/api/v2/img/waifu`)
    .then(res => res.json())
    .then(json => link = (json.url))

    let embed = new Discord.MessageEmbed()
    .setColor("#f2f8eb")
    .setTitle((message.author.username) + " here is your waifu! ")
...
exports.data = {
  name: "waifu", // name of command used on lists etc...
  category: "Anime", // what category the command is in
  usage: "waifu", // how to use the command
  description: "grabs a random image of a waifu", // description of what the command does
