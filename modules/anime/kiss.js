...
exports.run = async (client, message, args, settings) => {
    ...
    try {
    let results = await fetch(`https://nekos.life/api/v2/img/kiss`)
    .then(res => res.json())
...
exports.data = {
  name: "kiss", // name of command used on lists etc...
  category: "Anime", // what category the command is in
  usage: "kiss (`@username`)", // how to use the command
  description: "lets you kiss a user!", // description of what the command does
