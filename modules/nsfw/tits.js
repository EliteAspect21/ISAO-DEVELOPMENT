...
exports.run = async (client, message, args, settings) => {
    ...
    try {
    let results = await fetch(`https://nekos.life/api/v2/img/tits`)
    .then(res => res.json())
...
exports.data = {
  name: "tits", // name of command used on lists etc...
  category: "NSFW", // what category the command is in
  usage: "tits", // how to use the command
  description: "Grabs a random NSFW tits image", // description of what the command does
